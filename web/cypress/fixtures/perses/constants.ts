...
export enum persesDashboardsAddListVariableSource {
  ...
  PROMETHEUS_LABEL_VALUES_VARIABLE= 'Prometheus Label Values Variable',
  PROMETHEUS_LABEL_NAMES_VARIABLE= 'Prometheus Label Names Variable',
  PROMETHEUS_PROMQL_VARIABLE= 'Prometheus PromQL Variable',
  VICTORIALOGS_FIELD_NAMES_VARIABLE= 'VictoriaLogs Field Names Variable',
  VICTORIALOGS_FIELD_VALUES_VARIABLE= 'VictoriaLogs Field Values Variable',
}
