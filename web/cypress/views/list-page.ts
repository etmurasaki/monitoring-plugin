  ...
  filter: {
    ...
    byName: (name: string) => {
      ...
      try {
          ...
          cy.byLegacyTestID(DataTestIDs.NameLabelDropdown).scrollIntoView().click();
          cy.byLegacyTestID(DataTestIDs.NameLabelDropdownOptions).contains('Name').click();
    ...
    byLabel: (label: string) => {
      ...
      cy.byLegacyTestID(DataTestIDs.NameLabelDropdown).scrollIntoView().click();
      cy.byLegacyTestID(DataTestIDs.NameLabelDropdownOptions).contains('Label').click();
